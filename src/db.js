const project = [
  {
    ...
    notice:
      "크롬 브라우저로 확인해주세요. 해당 사이트는 Heroku Free 버전으로 배포되었습니다. 첫 연결 시, 서버가 재가동 되는 시간, 20-30초가 소요됩니다. 클릭하시고 조금만 기다려주세요."
  },
  {
    id: "2",
    title: "PRISMA SOCIAL",
    ...
    back: "100%",
    github: [
      "https://github.com/mememamumo/prismasocial",
      "https://github.com/mememamumo/prismasocial-frontend"
    ],
    ...
    notice:
      "크롬 브라우저로 확인해주세요. 해당 사이트는 Free 버전으로 배포되었습니다. 첫 연결 시, 서버가 재가동 되는 시간, 20-30초가 소요됩니다. 클릭하시고 조금만 기다려주세요."
  },
  {
    id: "3",
    title: "BAND BOOK",
